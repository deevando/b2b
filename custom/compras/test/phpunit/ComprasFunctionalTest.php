...
/**
 * \file    test/phpunit/ComprasFunctionalTest.php
 * \ingroup compras
 ...
 * @package Testcompras
 */
class ComprasFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/compras/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('compras/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/compras/admin/about.php');
		$this->authenticate();
		return $this->assertContains('compras/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('compraswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modCompras_ComprasTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modCompras_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
