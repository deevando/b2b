...
/**
 * \file    test/phpunit/DeevandoFunctionalTest.php
 * \ingroup deevando
 ...
 *
 * @package Testdeevando
 */
class DeevandoFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/deevando/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('deevando/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/deevando/admin/about.php');
		$this->authenticate();
		return $this->assertContains('deevando/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('deevandowidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDeevando_DeevandoTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDeevando_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
