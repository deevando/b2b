...
/**
 *	\file       htdocs/core/modules/commande/doc/pdf_deevando.modules.php
 *	\ingroup    commande
...
/**
 *	Class to generate PDF orders with template deevando
 */
class pdf_deevando extends ModelePDFCommandes
{
	/**
