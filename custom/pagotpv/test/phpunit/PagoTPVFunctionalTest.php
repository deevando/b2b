...
/**
 * \file    test/phpunit/PagoTPVFunctionalTest.php
 * \ingroup pagotpv
 ...
 * @package Testpagotpv
 */
class PagoTPVFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/pagotpv/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('pagotpv/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/pagotpv/admin/about.php');
		$this->authenticate();
		return $this->assertContains('pagotpv/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('pagotpvwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modPagoTPV_PagoTPVTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modPagoTPV_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
