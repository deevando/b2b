...
/**
 * \file    test/phpunit/ReportesFunctionalTest.php
 * \ingroup reportes
 ...
 */
class ReportesFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/reportes/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('reportes/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/reportes/admin/about.php');
		$this->authenticate();
		return $this->assertContains('reportes/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('reporteswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modReportes_ReportesTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modReportes_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
