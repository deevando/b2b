...
<form class="form-amount" action="pagotpv.php" method="post">
    <div class="form-group">
        <input type="hidden" id="amount" name="amount" class="form-control" placeholder="Por ejemplo: 50.00" value="<?php echo $amount; ?>";>
        <input type="hidden" id="pedido" name="numpedido" class="form-control" placeholder="Por ejemplo: 123443" value="<?php echo $numpedido; ?>";>
    </div>
    <br>
