...
/**
 * \file    test/phpunit/PersonaFunctionalTest.php
 * \ingroup persona
 ...
 * @package Testpersona
 */
class PersonaFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/persona/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('persona/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/persona/admin/about.php');
		$this->authenticate();
		return $this->assertContains('persona/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('personawidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modPersona_PersonaTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modPersona_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
